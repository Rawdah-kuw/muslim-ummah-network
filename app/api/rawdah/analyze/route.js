...
الحقول لكل درس:
▪ title: عنوان الدرس كاملاً بدون اسم الداعية. وفي الدروس اليومية أو السلاسل المستمرة اكتبي اسم السلسلة أو الكتاب العام فقط (مثل «شرح تفسير السعدي») دون تحديد جزء اليوم (السورة/الصفحة/رقم الحديث) لأنه يتغيّر أسبوعياً.
...
▪ days: مصفوفة كل أيام السلسلة إذا كانت عدة أيام لنفس الدرس (مثل «الأيام: الأحد • الإثنين • الأربعاء • الخميس») → ["الأحد","الاثنين","الأربعاء","الخميس"]. وإن كان الدرس **يومياً** («يومياً»، «كل يوم») فاجعليها كل الأيام السبعة ["الأحد","الاثنين","الثلاثاء","الأربعاء","الخميس","الجمعة","السبت"]. إن كان يومًا واحدًا فقط اتركيها [].
