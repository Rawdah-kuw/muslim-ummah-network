...
▪ days: مصفوفة الأيام إذا ذكر البوستر عدة أيام لنفس الدرس (مثل «الأيام: الأحد • الإثنين • الأربعاء • الخميس») → ["الأحد","الاثنين","الأربعاء","الخميس"]. إن كان يومًا واحدًا فقط اتركيها [].
▪ date_from / date_to: إذا ذُكر نطاق تواريخ («ابتداءً من 5 يوليو ولغاية 5 أغسطس 2026») فاكتبيهما بصيغة YYYY-MM-DD (date_from="2026-07-05"، date_to="2026-08-05")، وإلا "".

مهم: البوستر الذي فيه «الأيام: …» + «التاريخ: من … إلى …» هو **درس واحد** بعدة أيام ونطاق تواريخ — أرجعيه عنصرًا واحدًا مع days وdate_from وdate_to، ولا تكرّريه.
